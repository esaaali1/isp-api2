...
// شات الموقع التسويقي — عام بلا مصادقة Sanctum، لكن الهوية تُحقَّق
// بخطوتين (username + password، بنفس منطق /login) قبل أي أداة أو رد
// حقيقي — انظر AgentChatController للتفاصيل.
