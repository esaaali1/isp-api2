...
// شات الموقع التسويقي — معطَّل مؤقتاً (2026-08-29): ثغرة انتحال هوية
// حرجة — أي زائر يقدر يتحكم بـ username الجلسة دون تحقق كلمة مرور
// حقيقي. سيُعاد تفعيله بعد إكمال التحقق بخطوتين (username + password).
